...
namespace BIS.DAO
{
    public class ClientNotesDAO
    {
        private dbConnection conn;
        public ClientNotesDAO()
        {
            conn = new dbConnection();

        }

        public DataTable GetClientNotes(int idClient)
        {
            string query = string.Format(@"SELECT idNote,idClient,cpn.idEmployee,dtNoteDate,noteText,dtCreated,dtModified,idUserModified,idUserCreated, cpn.idTypeNote, u.nameUser AS nameUserCreated,tn.nameTypeNote AS nameType
              FROM ClientNotes cpn
        ...
        public DataTable GetClientNotesBy2(int idClient)
        {
            string query = string.Format(@"SELECT idNote,idClient,cpn.idEmployee,dtNoteDate,noteText,dtCreated,dtModified,idUserModified,idUserCreated, cpn.idTypeNote, u.nameUser AS nameUserCreated,tn.nameTypeNote AS nameType
              FROM ClientNotes cpn
              LEFT OUTER JOIN Users u ON u.idUser = cpn.idUserCreated
               LEFT OUTER JOIN TypesNote tn ON tn.idTypeNote = cpn.idTypeNote
                WHERE idClient = @idClient and cpn.idTypeNote = 2");
        ...
        public DataTable GetClientNote(int idNote)
        {
            string query = string.Format(@"SELECT idNote,idClient,idEmployee,dtNoteDate,noteText,dtCreated,dtModified,idUserModified,idUserCreated,idTypeNote
              FROM ClientNotes
                WHERE idNote = @idNote ");
        ...
        public bool Save(ClientNotesModel notes, string nameForm, int idUser)
        {
            List<string> _query = new List<string>();
            List<SqlParameter[]> sqlParameters = new List<SqlParameter[]>();

            string query = string.Format(@"INSERT INTO ClientNotes (idClient,idEmployee,dtNoteDate,noteText,dtCreated,dtModified,
                        idUserModified,idUserCreated, idTypeNote) 
                      VALUES(@idClient, @idEmployee, @dtNoteDate, @noteText, @dtCreated, @dtModified, @idUserModified,
            ...
            sqlParameter[0].Value = notes.idClient;
            ...
            sqlParameter[4].Value = conn.GetLastTableID("ClientNotes") + 1;

            sqlParameter[5] = new SqlParameter("@nameId", SqlDbType.NVarChar);
            sqlParameter[5].Value = "idNote";

            sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
            sqlParameter[6].Value = "ClientNotes";
        ...
        public bool Update(ClientNotesModel notes, string nameForm, int idUser)
        {
            List<string> _query = new List<string>();
            List<SqlParameter[]> sqlParameters = new List<SqlParameter[]>();

            string query = string.Format(@"UPDATE ClientNotes SET 
                    idClient = @idClient, idEmployee = @idEmployee, dtNoteDate = @dtNoteDate, 
            ...
            sqlParameter[1].Value = notes.idClient;
            ...
            sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
            sqlParameter[4].Value = notes.idNote.ToString();
        ...
        public bool Delete(int id, string nameForm, int idUser)
        {
            ...
            string query = string.Format(@"DELETE FROM  ClientNotes WHERE idNote = @idNote");
