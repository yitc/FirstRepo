...
namespace BIS.DAO
{
    public class VolontaryTripDAO
    {

        private dbConnection conn;

        public VolontaryTripDAO()
        {
        ...
        public DataTable GetVoluntaryQuestGroup(int idCompany)
        {
            ...
            string selectQuery = " select VolTripQuestGroup.idQuestGroup,nameQuestGroup from VolTripQuestGroup WHERE VolTripQuestGroup.idCompany = '" + idCompany + "'";
        ...
        public DataTable GetVoluntaryQuest(int idCompany, int idQuestGroup)
        {
            ...
            string selectQuery = "SELECT distinct VolTripQuest.idQuest,idQuestGroup,CONVERT(nvarchar(max),txtQuest) as txtQuest,questSort FROM VolTripQuest LEFT OUTER JOIN VolTripAns ON VolTripAns.idQuest = VolTripQuest.idQuest  WHERE idQuestGroup = '" + idQuestGroup + "' AND (idQuestGroup in (SELECT DISTINCT idQuestGroup FROM VolTripQuestGroup WHERE VolTripQuestGroup.idCompany = '" + idCompany + "') )  ORDER BY questSort";
        ...
        public DataTable GetVoluntaryAnswer(int idQuest, List<int> Labels)
        {
            ...
            for (int i = 0; i < Labels.Count; i++)
            {
                if (i == 0)
                {
                    condition = " WHERE VolTripAns.idQueryType='" + Labels[i].ToString() + "'";
                }
                else
                {
                    condition = condition + " OR VolTripAns.idQueryType='" + Labels[i].ToString() + "'";
                }
            }
            string selectQuery = "SELECT DISTINCT idAns,idAnsType,idQuest,idQueryType,l.nameLabel,CONVERT(nvarchar(max),txtAns) as txtAns,ansSort FROM VolTripAns LEFT OUTER JOIN Labels l  ON l.idLabel = VolTripAns.idQueryType WHERE idQuest = '" + idQuest + "' ORDER BY ansSort";
            if (condition != "" && condition != null)
            {
                selectQuery = "SELECT DISTINCT idAns,idAnsType,idQuest,idQueryType,l.nameLabel,CONVERT(nvarchar(max),txtAns) as txtAns,ansSort FROM VolTripAns LEFT OUTER JOIN Labels l  ON l.idLabel = VolTripAns.idQueryType WHERE idQuest = '" + idQuest + "' AND (" + condition.Replace("WHERE", "") + ") ORDER BY ansSort";
        ...
        public DataTable GetVoluntaryQuest(List<int> idQueryType)
        {
            ...
            string selectQuery = @"select mqg.nameQuestGroup,mqg.idQuestGroup,mq.idQuest, CONVERT(NVARCHAR(2000),mq.txtQuest) as txtQuest, ma.idAns,
                                     ma.txtAns,ma.idAnsType, mat.nameAnsType,ma.ansSort from VolTripQuest mq 
                                     left outer join VolTripQuestGroup mqg on mq.idQuestGroup = mqg.idQuestGroup 
                                     left outer join VolTripAns ma on ma.idQuest = mq.idQuest  
...
//        }
        ...
        public Boolean InsertVoluntaryQuestionGroup(QuestGroupModel qg, string nameForm, int idUser)
         {
             ...
             string insertQuery = " INSERT INTO VolTripQuestGroup (nameQuestGroup,idCompany) VALUES (@nameQuestGroup,@idCompany)";
             ...
             sqlParameter[4].Value = conn.GetLastTableID("VolTripQuestGroup") + 1;

             sqlParameter[5] = new SqlParameter("@nameId", SqlDbType.NVarChar);
             sqlParameter[5].Value = "idQuestGroup";

             sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
             sqlParameter[6].Value = "VolTripQuestGroup";
        ...
        public Boolean UpdateVoluntaryQuestionGroup(QuestGroupModel qg, string nameForm, int idUser)
         {
             ...
             string updateQuery = "UPDATE VolTripQuestGroup SET nameQuestGroup = @nameQuestGroup WHERE idQuestGroup = @idQuestGroup";
        ...
        public Boolean DeleteVoluntaryQuestionGroup(QuestGroupModel qg, string nameForm, int idUser)
         {
             ...
             string deleteQuery = "DELETE FROM VolTripQuestGroup WHERE idQuestGroup = @idQuestGroup";
        ...
        public Boolean InsertVoluntaryQuestion(QuestModel qg, string nameForm, int idUser)
         {
             ...
             string insertQuery = " INSERT INTO VolTripQuest (idQuestGroup,txtQuest,questSort) VALUES (@idQuestGroup,@txtQuest,@questSort)";
             ...
             sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
             sqlParameter[4].Value = conn.GetLastTableID("VolTripQuest") + 1;

             sqlParameter[5] = new SqlParameter("@nameId", SqlDbType.NVarChar);
             sqlParameter[5].Value = "idQuest";

             sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
             sqlParameter[6].Value = "VolTripQuest";
        ...
        public Boolean UpdateVoluntaryQuestion(QuestModel qg, string nameForm, int idUser)
         {
             ...
             string updateQuery = "UPDATE VolTripQuest SET txtQuest = @txtQuest, questSort = @QuestSort WHERE idQuest = @idQuest";
        ...
        public Boolean DeleteVoluntaryQuestion(QuestModel qg, string nameForm, int idUser)
         {
             ...
             string deleteQuery = "DELETE FROM VolTripQuest WHERE idQuest = @idQuest";
         ...
         {
             string selectQuery = "select top 1 idAns from VolTripAns order by idAns desc";
         ...
         public Boolean InsertVoluntaryAnswer(AnswerModel a, string nameForm, int idUser)
         {
             ...
             string insertQuery = " INSERT INTO VolTripAns (idAns,idAnsType,idQuest,idQueryType,txtAns,ansSort) VALUES (@idAns,@idAnsType,@idQuest,@idQueryType,@txtAns,@ansSort)";
             ...
             sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
             sqlParameter[6].Value = "VolTripAns";
         ...
         public Boolean UpdateVoluntaryAnswer(AnswerModel a, string nameForm, int idUser)
         {
             ...
             string updateQuery = "UPDATE VolTripAns set idAnsType = @idAnsType,txtAns = @txtAns,ansSort=@ansSort where idAns=@idAns";
         ...
         public DataTable GetSameQuestAnswer(string idQuest, string idAns)
         {
             ...
             string selectQuery = @"SELECT va.idQuest, idAns FROM VolTripAns va
                                LEFT OUTER JOIN VolTripQuest vq ON va.idQuest = vq.idQuest
                                WHERE  RTRIM(LTRIM(CONVERT(NVARCHAR(2000),vq.txtQuest))) + RTRIM(LTRIM(CONVERT(NVARCHAR(2000),va.txtAns))) = 
                                ( SELECT RTRIM(LTRIM(CONVERT(NVARCHAR(2000),vq.txtQuest))) + RTRIM(LTRIM(CONVERT(NVARCHAR(2000),va.txtAns))) FROM  VolTripAns va
                                LEFT OUTER JOIN VolTripQuest vq ON va.idQuest = vq.idQuest WHERE va.idQuest='" + idQuest + "' AND va.idAns= '" + idAns + "')";
         ...
         public DataTable GetVoluntary(List<String> idQueryType, int idContPers, Boolean isDefaultSort, Boolean isAll)
        {
            ...
            string selectQuery = "select distinct nameQuestGroup,idQuest,txtQuest,idAns,txtAns, idAnsType,idCpr, txt, questSort, ansSort FROM (select distinct vqg.nameQuestGroup,(SELECT TOP 1 idQuest FROM VolTripQuest v where CONVERT(NVARCHAR(2000),v.txtQuest) = CONVERT(NVARCHAR(2000),vq.txtQuest)) as idQuest, CONVERT(NVARCHAR(2000),vq.txtQuest) as txtQuest, (SELECT TOP 1 idAns FROM VolTripAns v LEFT OUTER JOIN VolTripQuest vqq ON v.idQuest = vqq.idQuest where CONVERT(NVARCHAR(2000),vqq.txtQuest)+CONVERT(NVARCHAR(2000),v.txtAns) = CONVERT(NVARCHAR(2000),vq.txtQuest)+CONVERT(NVARCHAR(2000),va.txtAns)) as idAns, va.txtAns,va.idAnsType," +
                "vc.idCpr, CONVERT(NVARCHAR(2000),vc.txt) as txt,(SELECT TOP 1 questSort FROM VolTripQuest v where CONVERT(NVARCHAR(2000),v.txtQuest) = CONVERT(NVARCHAR(2000),vq.txtQuest)) as questSort, (SELECT TOP 1 ansSort FROM VolTripAns v LEFT OUTER JOIN VolTripQuest vqq ON v.idQuest = vqq.idQuest where CONVERT(NVARCHAR(2000),vqq.txtQuest)+CONVERT(NVARCHAR(2000),v.txtAns) = CONVERT(NVARCHAR(2000),vq.txtQuest)+CONVERT(NVARCHAR(2000),va.txtAns))  as ansSort from VolTripQuest vq " + join + " VolTripQuestGroup vqg on vq.idQuestGroup = vqg.idQuestGroup " + join + " VolTripAns va on " +
                "va.idQuest = vq.idQuest " + join + "  (select vcp.idcpr, vqu.txtQuest, van.txtAns,vcp.txt from VolTripCpr vcp " + join + @" VolTripQuest vqu ON vqu.idQuest = vcp.idQuest
               " + join + " VolTripAns van ON van.idAns = vcp.idAns where (idCpr = '" + idContPers + "' or idCpr is null)) vc on CONVERT(NVARCHAR(2000),vc.txtQuest) = CONVERT(NVARCHAR(2000),vq.txtQuest) and CONVERT(NVARCHAR(2000),va.txtAns) = CONVERT(NVARCHAR(2000),vc.txtAns) and va.idAns is not null " +
                " ) cc  order by "+sort;
         ...
         public DataTable GetVoluntaryTripArrDetails(List<String> idQueryType, int idArrangement, Boolean isDefaultSort, Boolean isAll)
         {
             string queryCondition = "where";
             string join = "inner join";
             ...
             string selectQuery = "select distinct vqg.nameQuestGroup,vq.idQuest, CONVERT(NVARCHAR(2000),vq.txtQuest) as txtQuest, va.idAns, va.txtAns,va.idAnsType," +
                 "vc.idArrangement, CONVERT(NVARCHAR(2000),vc.txt) as txt,vq.questSort, va.ansSort from VolTripQuest vq " + join + " VolTripQuestGroup vqg on vq.idQuestGroup = vqg.idQuestGroup " + join + " VolTripAns va on " +
                 "va.idQuest = vq.idQuest " + join + "  (select * from VolTripArr where (idArrangement = '" + idArrangement + "' or idArrangement is null)) vc on vc.idQuest = vq.idQuest and va.idAns = vc.idAns  " +
                 " order by " + sort;
         ...
         public Boolean SaveVoluntary(VolontaryTripModel vol, string nameForm, int idUser)
        {
            List<string> _query = new List<string>();
            List<SqlParameter[]> sqlParameters = new List<SqlParameter[]>();
            //string dateTimeChanged = DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss");

            string insertQuery = "insert into VolTripCpr (idcpr,idQuest,idAns,txt) values( @idcpr,@idQuest,@idAns,@txt)";
            ...
            sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
            sqlParameter[4].Value = conn.GetLastTableID("VolTripCpr") + 1;

            sqlParameter[5] = new SqlParameter("@nameId", SqlDbType.NVarChar);
            sqlParameter[5].Value = "idVol";

            sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
            sqlParameter[6].Value = "VolTripCpr";
         ...
         public Boolean DeleteVoluntary(int idContPers, string nameForm, int idUser)
        {
            ...
            string deleteQuery = "delete from VolTripCpr where idcpr = @idcpr";
         ...
         public Boolean SaveVoluntaryArrangement(VolontaryTripModel vol, string nameForm, int idUser)
        {
            List<string> _query = new List<string>();
            List<SqlParameter[]> sqlParameters = new List<SqlParameter[]>();
            //string dateTimeChanged = DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss");

            string insertQuery = "insert into VolTripArr (idArrangement,idQuest,idAns,txt) values( @idArrangement,@idQuest,@idAns,@txt)";
            ...
            sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
            sqlParameter[4].Value = conn.GetLastTableID("VolTripArr") + 1;

            sqlParameter[5] = new SqlParameter("@nameId", SqlDbType.NVarChar);
            sqlParameter[5].Value = "idVol";

            sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
            sqlParameter[6].Value = "VolTripArr";
         ...
         public Boolean DeleteVoluntaryArrangement(int idArrangement, string nameForm, int idUser)
        {
            ...
            string deleteQuery = "delete from VolTripArr where idArrangement = @idArrangement";
        ...
        //==============================
        public DataTable checkIsOneAnsVT(AnswerModel ma)
        {
        ...
        public DataTable checkIsOneQuestVT(int idGroup)
        {
            string query = string.Format(@"SELECT distinct ma.idQuest
                                           FROM VolTripQuest ma                                 
        ...
        public DataTable checkAnsIsInVTCpr(int idAns, int idQueryType)
        {
            string query = string.Format(@"SELECT distinct mcpr.idAns,mcpr.idcpr, cpl.idLabel
                                           FROM VolTripAns ma
                                           INNER JOIN VolTripCpr mcpr on ma.idAns= mcpr.idAns
        ...
        public DataTable checkAnsIsInVTArr(int idAns, int idQueryType)
        {
            string query = string.Format(@"SELECT distinct mcpr.idAns
                                           FROM VolTripAns ma
                                           INNER JOIN VolTripArr mcpr on ma.idAns= mcpr.idAns
                                           WHERE ma.idAns = '" + idAns + "' AND ma.idQueryType='" + idQueryType + "' ");
        ...
        public Boolean DeleteAnsSriptVT(AnswerModel ma, bool quest, bool group, int idQuestGroup, string nameForm, int idUser)
        {
            List<string> _query = new List<string>();
            List<SqlParameter[]> sqlParameters = new List<SqlParameter[]>();
            ...
            if (ma.idAns != -1)
            {
                string query = string.Format(@"DELETE FROM VolTripAns WHERE idAns = @idAns AND idQueryType=@idQueryType");
                ...
                sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
                sqlParameter[4].Value = ma.idAns + "_" + ma.idQueryType;
                ...
                sqlParameter[7] = new SqlParameter("@description", SqlDbType.NVarChar);
                sqlParameter[7].Value = "Delete ans sript VT";
            ...
            if (quest == true)
            {
                if (ma.idQuest != -1)
                {
                    string query = string.Format(@"DELETE FROM VolTripQuest WHERE idQuest = @idQuest");
                ...
                if (group == true)
                {
                    ...
                    string query = string.Format(@"DELETE FROM VolTripQuestGroup WHERE idQuestGroup = @idQuestGroup");
        ...
        public DataTable checkIsOneQuestInGroupVT(QuestModel ma)
        {
            string query = string.Format(@"SELECT distinct ma.idQuest
                                           FROM VolTripQuest ma                                 
        ...
        public Boolean DeleteQuestSriptVT(QuestModel ma, bool group, string nameForm, int idUser)
        {
            ...
            sqlParameter[7] = new SqlParameter("@description", SqlDbType.NVarChar);
            sqlParameter[7].Value = "Delete quest sript VT";
            ...
            if (group == true)
            {
                query = string.Format(@"DELETE FROM VolTripQuestGroup WHERE idQuestGroup = @idQuestGroup");
