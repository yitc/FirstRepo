    ...
    public class PersonDAO
    {
        ...
        public DataTable GetPerson(int idContPers)
        {
            string query = string.Format(@"
                SELECT idContPers, initialsContPers, firstname, midname, lastname, maidenname, cp.idTitle,t.nameTitle, idGender, birthdate, dtCreated, 
        ...
        public DataTable GetAllPersons(int idFilter, List<int> labels, string idLang)
        {
            ...
            string query = string.Format(@"SELECT cp.idContPers,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,dtCreated,
                idUserCreated,dtModified,idUserModified,idUserResponsible,isMaried,isActive,dtOfActive,isDied,dtOfDeath,isNeedProspect,
        ...
        public bool Save(PersonModel person, string nameForm, int idUser)
        {
            ...
            sqlParameter[0] = new SqlParameter("@initialsContPers", SqlDbType.NVarChar);
            sqlParameter[0].Value = person.initialsContPers;

            sqlParameter[1] = new SqlParameter("@firstname", SqlDbType.NVarChar);
            sqlParameter[1].Value = person.firstname;

            sqlParameter[2] = new SqlParameter("@midname", SqlDbType.NVarChar);
            sqlParameter[2].Value = person.midname;

            sqlParameter[3] = new SqlParameter("@lastname", SqlDbType.NVarChar);
            sqlParameter[3].Value = person.lastname;

            sqlParameter[4] = new SqlParameter("@maidenname", SqlDbType.NVarChar);
            sqlParameter[4].Value = person.maidenname;

            sqlParameter[5] = new SqlParameter("@idTitle", SqlDbType.Int);
            sqlParameter[5].Value = person.idTitle;

            sqlParameter[6] = new SqlParameter("@idGender", SqlDbType.Int);
            //sqlParameters[6].Value = (person.idGender == null) ? SqlInt32.Null : person.idGender;
            sqlParameter[6].Value = person.idGender;

            //sqlParameter[7] = new SqlParameter("@birthdate", SqlDbType.DateTime);
            //sqlParameter[7].Value = (person.birthdate == null || person.birthdate == DateTime.MinValue) ? SqlDateTime.Null : person.birthdate;

            if (person.birthdate == null)
            {
                sqlParameter[7] = new SqlParameter("@birthdate", SqlDbType.DateTime);
                sqlParameter[7].Value = DBNull.Value;
            }
            else
            {
                sqlParameter[7] = new SqlParameter("@birthdate", SqlDbType.DateTime);
                sqlParameter[7].Value = person.birthdate;
            }


            sqlParameter[8] = new SqlParameter("@dtCreated", SqlDbType.DateTime);
            sqlParameter[8].Value = (person.dtCreated == null || person.dtCreated == DateTime.MinValue) ? SqlDateTime.Null : person.dtCreated;

            sqlParameter[9] = new SqlParameter("@idUserCreated", SqlDbType.Int);
            sqlParameter[9].Value = person.idUserCreated;

            sqlParameter[10] = new SqlParameter("@dtModified", SqlDbType.DateTime);
            sqlParameter[10].Value = (person.dtModified == null || person.dtModified == DateTime.MinValue) ? SqlDateTime.Null : person.dtModified;

            sqlParameter[11] = new SqlParameter("@idUserModified", SqlDbType.Int);
            sqlParameter[11].Value = person.idUserModified;

            sqlParameter[12] = new SqlParameter("@idUserResponsible", SqlDbType.Int);
            sqlParameter[12].Value = person.idUserResponsible;

            sqlParameter[13] = new SqlParameter("@isMaried", SqlDbType.Bit);
            sqlParameter[13].Value = person.isMaried;

            sqlParameter[14] = new SqlParameter("@isActive", SqlDbType.Bit);
            sqlParameter[14].Value = person.isActive;

            sqlParameter[15] = new SqlParameter("@isDied", SqlDbType.Bit);
            sqlParameter[15].Value = person.isDied;

            sqlParameter[16] = new SqlParameter("@dtOfDeath", SqlDbType.DateTime);
            sqlParameter[16].Value = (person.dtOfDeath == null || person.dtOfDeath == DateTime.MinValue) ? SqlDateTime.Null : person.dtOfDeath;

            sqlParameter[17] = new SqlParameter("@isNeedProspect", SqlDbType.Int);
            sqlParameter[17].Value = person.isNeedProspect;

            sqlParameter[18] = new SqlParameter("@isNeedMail", SqlDbType.Int);
            sqlParameter[18].Value = person.isNeedMail;

            sqlParameter[19] = new SqlParameter("@imageContPers", SqlDbType.NVarChar);
            sqlParameter[19].Value = (person.imageContPers == null) ? SqlString.Null : person.imageContPers;

            sqlParameter[20] = new SqlParameter("@identBSN", SqlDbType.NVarChar);
            sqlParameter[20].Value = (person.identBSN == null) ? SqlString.Null : person.identBSN;

            sqlParameter[21] = new SqlParameter("@isPayInvoice", SqlDbType.Bit);
            sqlParameter[21].Value = person.isPayInvoice;

            sqlParameter[22] = new SqlParameter("@isSharePicture", SqlDbType.Bit);
            sqlParameter[22].Value = person.isSharePicture;

            sqlParameter[23] = new SqlParameter("@isPaperByMail", SqlDbType.Bit);
            sqlParameter[23].Value = person.isPaperByMail;

            sqlParameter[24] = new SqlParameter("@isContactPerson", SqlDbType.Bit);
            sqlParameter[24].Value = person.isContactPerson;

            sqlParameter[25] = new SqlParameter("@idClient", SqlDbType.Int);
            sqlParameter[25].Value = person.idClient;

            sqlParameter[26] = new SqlParameter("@livesIn", SqlDbType.Int);
            sqlParameter[26].Value = person.livesIn;

            sqlParameter[27] = new SqlParameter("@idCpFunction", SqlDbType.Int);
            sqlParameter[27].Value = person.idCpFunction;

            sqlParameter[28] = new SqlParameter("@isRequestBrochure", SqlDbType.Bit);
            sqlParameter[28].Value = person.isRequestBrochure;

            sqlParameter[29] = new SqlParameter("@idReasonIn", SqlDbType.Int);
            sqlParameter[29].Value = person.idReasonIn;

            sqlParameter[30] = new SqlParameter("@idReasonOut", SqlDbType.Int);
            sqlParameter[30].Value = person.idReasonOut;

            sqlParameter[31] = new SqlParameter("@volProfession", SqlDbType.NVarChar);
            sqlParameter[31].Value = person.volProfession;

            sqlParameter[32] = new SqlParameter("@travelInsurance", SqlDbType.NVarChar);
            sqlParameter[32].Value = person.travelInsurance;

            sqlParameter[33] = new SqlParameter("@polisNumber", SqlDbType.NVarChar);
            sqlParameter[33].Value = person.polisNumber;

            sqlParameter[34] = new SqlParameter("@alarmNumber", SqlDbType.NVarChar);
            sqlParameter[34].Value = person.alarmNumber;

            sqlParameter[35] = new SqlParameter("@idContPersBookingTo", SqlDbType.NVarChar);
            sqlParameter[35].Value = person.idContPersBookingTo;

            sqlParameter[36] = new SqlParameter("@dtOfActive", SqlDbType.DateTime);
            sqlParameter[36].Value = (person.dtOfActive == null || person.dtOfActive == DateTime.MinValue) ? SqlDateTime.Null : person.dtOfActive;
            ...
            sqlParameter[4].Value = conn.GetLastTableID("ContactPerson")+1;

            sqlParameter[5] = new SqlParameter("@nameId", SqlDbType.NVarChar);
            sqlParameter[5].Value = "idContPers";

            sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
            sqlParameter[6].Value = "ContactPerson";

            sqlParameter[7] = new SqlParameter("@description", SqlDbType.NVarChar);
            sqlParameter[7].Value = "Save contact person";
        ...
        public bool Update(PersonModel person, string nameForm, int idUser)
        {
            ...
            string query = string.Format(@"UPDATE ContactPerson SET  
                    ...
                    idReasonIn=@idReasonIn,idReasonOut=@idReasonOut,volProfession=@volProfession, dtOfActive = @dtOfActive,
            ...
            sqlParameter[19] = new SqlParameter("@imageContPers", SqlDbType.NVarChar);
            sqlParameter[19].Value = person.imageContPers;
            ...
            sqlParameter[29] = new SqlParameter("@idContPers", SqlDbType.Int);
            sqlParameter[29].Value = person.idContPers;

            sqlParameter[30] = new SqlParameter("@idReasonIn", SqlDbType.Int);
            sqlParameter[30].Value = person.idReasonIn;

            sqlParameter[31] = new SqlParameter("@idReasonOut", SqlDbType.Int);
            sqlParameter[31].Value = person.idReasonOut;

            sqlParameter[32] = new SqlParameter("@volProfession", SqlDbType.NVarChar);
            sqlParameter[32].Value = person.volProfession;

            sqlParameter[33] = new SqlParameter("@travelInsurance", SqlDbType.NVarChar);
            sqlParameter[33].Value = person.travelInsurance;

            sqlParameter[34] = new SqlParameter("@polisNumber", SqlDbType.NVarChar);
            sqlParameter[34].Value = person.polisNumber;

            sqlParameter[35] = new SqlParameter("@alarmNumber", SqlDbType.NVarChar);
            sqlParameter[35].Value = person.alarmNumber;

            sqlParameter[36] = new SqlParameter("@idContPersBookingTo", SqlDbType.NVarChar);
            sqlParameter[36].Value = person.idContPersBookingTo;

            sqlParameter[37] = new SqlParameter("@dtOfActive", SqlDbType.DateTime);
            sqlParameter[37].Value = (person.dtOfActive == null || person.dtOfActive == DateTime.MinValue) ? SqlDateTime.Null : person.dtOfActive;
            ...
            sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
            sqlParameter[4].Value = person.idContPers;
            ...
            sqlParameter[7] = new SqlParameter("@description", SqlDbType.NVarChar);
            sqlParameter[7].Value = "Update contact person";
        ...
        public DataTable GetVHPersons(int idArrangement, int idContPers, string idLang, List<int> CheckedFun, List<int> CheckedQuest, List<int> CheckedTrip, List<int> CheckedTripQuest, List<int> CheckedVol, List<int> CheckedVolQuest)
        {
            ...
            string query = string.Format(@"
                ...
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
                WHERE cp.isActive = 'false' AND cp.isDied = 'false' AND idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"' AND idStatus<>'4') 
                AND idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook ab LEFT OUTER JOIN Arrangement a 
                ON ab.idArrangement = a.idArrangement WHERE  ab.idStatus<>'3' AND ab.idStatus<>'4' AND (a.dtTOArrangement  Between (SELECT DATEADD(dd,-3,dtfromArrangement) FROM Arrangement WHERE idArrangement = '" + idArrangement + @"') 
                AND (SELECT  DATEADD(dd,+3,dttoArrangement) FROM Arrangement WHERE idArrangement = '" + idArrangement + @"')) AND
        ...
        public DataTable GetArrangementPersonsLookup(int idArrangement, int idContPers, string idLang)
        {
            string query = string.Format(@"
                ...
                AND idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"' AND idArrangementBook IN (SELECT DISTINCT idArrangementBook FROM ArrangementBookPersons) and idStatus<>'4')
                AND idContPers NOT IN (SELECT DISTINCT apb.idContPers FROM ArrangementBookPersons apb 
                INNER JOIN ArrangementBook ab ON ab.idArrangementBook=apb.idArrangementBook 
                WHERE ab.idArrangement = '" + idArrangement + @"' AND apb.idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook 
                WHERE idArrangement = '" + idArrangement + @"' AND idContPers = apb.idContPers)
                )
                AND idContPers NOT IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4') 
                AND idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"'  AND idStatus > '2' AND idStatus <> '4' )
                 AND idContPers NOT IN   (SELECT idContPers
       FROM
       (
       SELECT  DISTINCT idContPers,idStatus
       FROM ArrangementBook
       where  idArrangement = '" + idArrangement + @"' AND idContPers IN
       ( SELECT idContPers FROM (
       SELECT idContPers, idStatus
       FROM ArrangementBook
       where  idArrangement = '" + idArrangement + @"' AND idStatus = '4'
       ) dd 
       GROUP BY idContPers HAVING COUNT(idStatus)>=1))cc
       GROUP BY idContPers HAVING COUNT(idStatus)<=1)
                AND idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"'  AND (idStatus = '2') AND idArrangementBook in (SELECT DISTINCT idVoucher FROM Invoice))
               AND idContPers NOT IN (SELECT DISTINCT abp.idContPers FROM ArrangementBookPersons abp LEFT OUTER JOIN  ArrangementBook ab ON ab.idArrangementBook=abp.idArrangementBook WHERE idArrangement = '" + idArrangement + @"' and ab.idStatus<>'4' ) 
                UNION
                SELECT cp.idContPers,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,dtCreated,
                idUserCreated,dtModified,idUserModified,idUserResponsible,isMaried,isActive,isDied,dtOfDeath,isNeedProspect,
                isNeedMail,identBSN,isPayInvoice,cp.isSharePicture,isPaperByMail,isContactPerson,idClient,livesIn,idCpFunction
                ...
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @"  s ON g.nameGender=s.stringKey 
                RIGHT OUTER JOIN (SELECT DISTINCT apb.idContPers FROM ArrangementBookPersons apb INNER JOIN ArrangementBook ab ON ab.idArrangementBook=apb.idArrangementBook WHERE ab.idArrangement = '" + idArrangement + "' and ab.idContPers='" + idContPers + @"' AND idStatus<>'4') acc ON acc.idContPers = cp.idContPers 
        ...
        public DataTable GetArrangementPersons(int idArrangementBook, string idLang)
        {
            string query = string.Format(@"
                ...
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
                WHERE idContPers IN (SELECT DISTINCT abp.idContPers FROM ArrangementBookPersons abp
                LEFT OUTER JOIN ArrangementBook ab ON ab.idArrangementBook = abp.idArrangementBook
                WHERE abp.idArrangementBook = '"+idArrangementBook+@"' ) 
                AND idContPers NOT IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4')");
        ...
        {
            string query = string.Format(@"
               SELECT cp.idContPers,pp.idArrangementBook,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,pp.dtUserCreated as dtCreated, 
                pp.idUserCreated, u.nameUser,pp.dtUserModified as dtModified,pp.idUserModified,idUserResponsible,isMaried,isActive,isDied,dtOfDeath,isNeedProspect,
                isNeedMail,identBSN,isPayInvoice,cp.isSharePicture,isPaperByMail,isContactPerson,idClient,livesIn,idCpFunction,isRequestBrochure,pp.idStatus,pp.nameStatus,pp.dtBooked,'Traveler' as type,pp.isInsurance
                FROM ContactPerson cp
                LEFT JOIN Gender g ON g.idGender = cp.idGender
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
                LEFT OUTER JOIN (SELECT DISTINCT dtUserCreated,idUserCreated,dtUserModified,idUserModified,idContPers,abst.idStatus,abst.nameStatus,ab.dtBooked,isInsurance,idArrangementBook FROM ArrangementBook ab LEFT OUTER JOIN ArrangementBookStatus abst ON abst.idStatus = ab.idStatus WHERE ab.idArrangement = '" + idArrangement + @"') pp ON pp.idContPers = cp.idContPers
                LEFT OUTER JOIN Users u ON u.idUser = pp.idUserCreated                
                ...
                SELECT cp.idContPers,pp.idArrangementBook,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,pp.dtUserCreated as dtCreated,
                pp.idUserCreated, u.nameUser,pp.dtUserModified as dtModified,pp.idUserModified,idUserResponsible,isMaried,isActive,isDied,dtOfDeath,isNeedProspect,
                isNeedMail,identBSN,isPayInvoice,cp.isSharePicture,isPaperByMail,isContactPerson,idClient,livesIn,idCpFunction,isRequestBrochure,pp.idStatus,pp.nameStatus,pp.dtBooked,'Voluntary helper' as type,pp.isInsurance
                FROM ContactPerson cp
                LEFT JOIN Gender g ON g.idGender = cp.idGender
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
        ...
        public DataTable GetExactPersonsForArrangement(int idArrangementBook, string idLang, int idContPers)
        {
            string query = string.Format(@"
               SELECT cp.idContPers,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,pp.dtUserCreated as dtCreated, 
                pp.idUserCreated, u.nameUser,pp.dtUserModified as dtModified,pp.idUserModified,idUserResponsible,isMaried,isActive,isDied,dtOfDeath,isNeedProspect,
                isNeedMail,identBSN,isPayInvoice,cp.isSharePicture,isPaperByMail,isContactPerson,idClient,livesIn,idCpFunction,isRequestBrochure,pp.idStatus,pp.nameStatus,pp.dtBooked,pp.idArrangementBook,'Traveler' as type,pp.isInsurance
                FROM ContactPerson cp
                LEFT JOIN Gender g ON g.idGender = cp.idGender
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
                LEFT OUTER JOIN (SELECT DISTINCT dtUserCreated,idUserCreated,dtUserModified,idUserModified,idContPers,abst.idStatus,abst.nameStatus,ab.dtBooked,ab.idArrangementBook,isInsurance FROM ArrangementBook ab LEFT OUTER JOIN ArrangementBookStatus abst ON abst.idStatus = ab.idStatus WHERE ab.idArrangementBook = '" + idArrangementBook + @"') pp ON pp.idContPers = cp.idContPers
                LEFT OUTER JOIN Users u ON u.idUser = pp.idUserCreated                
                WHERE cp.idContPers IN (SELECT DISTINCT idContPers FROM ArrangementBook  WHERE idArrangementBook = '" + idArrangementBook + @"')
                AND cp.idContPers NOT IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4') AND cp.idContPers='" + idContPers + @"'
                UNION
                SELECT cp.idContPers,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,pp.dtUserCreated as dtCreated,
                pp.idUserCreated, u.nameUser,pp.dtUserModified as dtModified,pp.idUserModified,idUserResponsible,isMaried,isActive,isDied,dtOfDeath,isNeedProspect,
                isNeedMail,identBSN,isPayInvoice,cp.isSharePicture,isPaperByMail,isContactPerson,idClient,livesIn,idCpFunction,isRequestBrochure,pp.idStatus,pp.nameStatus,pp.dtBooked,pp.idArrangementBook,'Voluntary helper' as type,pp.isInsurance
                FROM ContactPerson cp
                LEFT JOIN Gender g ON g.idGender = cp.idGender
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
                ...
                LEFT OUTER JOIN (SELECT DISTINCT dtUserCreated,idUserCreated,dtUserModified,idUserModified,idContPers,abst.idStatus,abst.nameStatus,ab.dtBooked,ab.idArrangementBook,isInsurance FROM ArrangementBook ab LEFT OUTER JOIN ArrangementBookStatus abst ON abst.idStatus = ab.idStatus WHERE ab.idArrangementBook = '" + idArrangementBook + @"') pp ON pp.idContPers = cp.idContPers
                LEFT OUTER JOIN Users u ON u.idUser = pp.idUserCreated                
                WHERE cp.idContPers IN (SELECT DISTINCT idContPers FROM ArrangementBook mm WHERE idArrangementBook = '" + idArrangementBook + @"')
                AND cp.idContPers IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4') AND cp.idContPers='" + idContPers + @"'");
        ...
        public DataTable GetPersonsVHForArrangement(int idArrangement, string idLang)
        {
             string query = string.Format(@"
                ...
                WHERE cp.idContPers IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"')
                AND pp.idStatus <> '3' AND pp.idStatus <> '4' AND cp.idContPers IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4')");
        ...
        //======= Getting Male Vol Helpers
         public DataTable GetMalePersonsVHForArrangement(int idArrangement, string idLang)
         {
             string query = string.Format(@"
                ...
                LEFT OUTER JOIN (SELECT DISTINCT idContPers,abst.idStatus,abst.nameStatus FROM ArrangementBook ab LEFT OUTER JOIN ArrangementBookStatus abst ON abst.idStatus = ab.idStatus WHERE ab.idArrangement = '" + idArrangement + @"') pp ON pp.idContPers = cp.idContPers
                WHERE cp.idContPers IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"')
                AND pp.idStatus <> '3' AND pp.idStatus <> '4' AND cp.idContPers IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4')and cp.idGender = '1'");
...
//        
         ...
         public DataTable GetAllArrangement(int idContPers)
         {
             ...
             string query = string.Format(@"SELECT DISTINCT a.idArrangement,codeArrangement,nameArrangement, dtFromArrangement,dtToArrangement,nrOfNights,
                                        ...
                                        Left  OUTER JOIN AgeCategory cat on a.idAgeCategory = cat.idAgeCategory
                                         WHERE a.idArrangement NOT IN (SELECT DISTINCT idArrangement FROM ArrangementBook WHERE idContPers= @idContPers and idStatus<>4)");
        ...
        public DataTable GetArrangementsForPerson(int idPerson)
        {
            string query = string.Format(@"
                SELECT ab.idArrangement, a.codeArrangement, a.nameArrangement, a.dtFromArrangement,a.dtToArrangement,
                                        ...
                                        a.nrMaximumWheelchairs, a.whoseElectricWheelchairs, a.buSupportingArms, a.nrAnchorage 
        ...
        public DataTable NrTraveler(int idArrangement)
        {
            ...
            FROM ArrangementBook
            WHERE idArrangement = @idArrangement and (idStatus=1 or idStatus=2) and idContPers IN (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter <> '4' )) AS ID
            FROM Arrangement
            WHERE idArrangement = @idArrangement");
        ...
        public DataTable CountNrTraveling(int idContpers)
        {
            ...
            AND  LEFT(e.codeArrangement,3) != 'BHC' AND dtBooked >= '09-01-2016 00:00:000'");
            SqlParameter[] sqlParameters = new SqlParameter[1];
        ...
        public bool SaveArrangement(int idArrangement, int idContPers, int idStatus, int idTravelPapers, decimal price, string nameForm, int idUser)
        {
            ...
            sqlParameter[2].Value = (idStatus == -1) ? SqlInt32.Null : idStatus;

            sqlParameter[3] = new SqlParameter("@idTravelPapers", SqlDbType.Int);
            sqlParameter[3].Value = (idTravelPapers == -1) ? SqlInt32.Null : idTravelPapers;

            sqlParameter[4] = new SqlParameter("@price", SqlDbType.Decimal);
            sqlParameter[4].Value = (price == -1) ? SqlDecimal.Null : price;
            ...
            sqlParameter[4] = new SqlParameter("@id", SqlDbType.NVarChar);
            sqlParameter[4].Value = conn.GetLastTableID("ArrangementBook");
            ...
            sqlParameter[7] = new SqlParameter("@description", SqlDbType.NVarChar);
            sqlParameter[7].Value = "Save arrangement";
        ...
        public Boolean DeletePerson(int idContPers, string nameForm, int idUser)
        {
            List<string> _query = new List<string>();
            List<SqlParameter[]> sqlParameters = new List<SqlParameter[]>();
            ...
            sqlParameter[6] = new SqlParameter("@tableName", SqlDbType.NVarChar);
            sqlParameter[6].Value = "ContactPersonLabel,ContactPersonNotes,ContactPersonFilter,ContactPersonAddress,ContactPersonEmail,ContactPersonPassport,ContactPersonTargetGroup,MedCpr,VolAvailability,VolCpr,VolFeatures,VolFunctionCpr,VolSimilarity,VolSimilarityArchive,VolTripCpr";

            sqlParameter[7] = new SqlParameter("@description", SqlDbType.NVarChar);
            sqlParameter[7].Value = "Delete person";
        ...
        public DataTable GetTravelers(int idArrangement, int idContPers, string idLang, List<string> CheckedCity, List<string> CheckedQuest, List<int> CheckedMedical, List<int> CheckedMedicalQuest)
        {
            ...
            string query = string.Format(@"
                ...
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
                WHERE cp.isActive = 'false' AND cp.isDied = 'false' AND
                idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"' AND idStatus<>'4') 
                AND idContPers NOT IN (SELECT DISTINCT idContPers FROM ArrangementBook ab LEFT OUTER JOIN Arrangement a 
                ...
                AND (SELECT  DATEADD(dd,+3,dttoArrangement) FROM Arrangement WHERE idArrangement = '" + idArrangement + @"')) AND
                (a.dtfromArrangement Between (SELECT  DATEADD(dd,-3,dtfromArrangement) FROM Arrangement WHERE idArrangement = '" + idArrangement + @"') AND (SELECT  DATEADD(dd,+3,dttoArrangement) FROM Arrangement WHERE idArrangement = '" + idArrangement + @"')) AND idStatus<>'4')
                AND idContPers NOT IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4') ");
        ...
        public DataTable GetFemalePersonsVHForArrangement(int idArrangement, string idLang)
        {
            string query = string.Format(@"
                ...
                LEFT OUTER JOIN (SELECT DISTINCT idContPers,abst.idStatus,abst.nameStatus FROM ArrangementBook ab LEFT OUTER JOIN ArrangementBookStatus abst ON abst.idStatus = ab.idStatus WHERE ab.idArrangement = '" + idArrangement + @"') pp ON pp.idContPers = cp.idContPers
                WHERE cp.idContPers IN (SELECT DISTINCT idContPers FROM ArrangementBook WHERE idArrangement = '" + idArrangement + @"')
                AND pp.idStatus <>'3' AND pp.idStatus <> '4' AND cp.idContPers IN  (SELECT DISTINCT idContPers FROM ContactPersonFilter WHERE idFilter = '4')and cp.idGender = '2'");
        ...
        //=================================
        public DataTable GetExactPersonBookForArrangementByIdArrangementBook(int idArrangementBook, string idLang)
        {
            string query = string.Format(@"
               SELECT cp.idContPers,initialsContPers,firstname,midname,lastname,maidenname,cp.idTitle,t.nameTitle,cp.idGender,CASE WHEN s.stringvalue IS NOT NULL THEN s.stringvalue ELSE g.nameGender END AS nameGender,birthdate,pp.dtUserCreated as dtCreated, 
                pp.idUserCreated, u.nameUser,pp.dtUserModified as dtModified,pp.idUserModified,idUserResponsible,isMaried,isActive,isDied,dtOfDeath,isNeedProspect,
                isNeedMail,identBSN,isPayInvoice,cp.isSharePicture,isPaperByMail,isContactPerson,idClient,livesIn,idCpFunction,isRequestBrochure,pp.idStatus,pp.nameStatus,pp.dtBooked,'Traveler' as type,pp.isInsurance
                ,pp.idArrangementBook                
                FROM ContactPerson cp
                LEFT JOIN Gender g ON g.idGender = cp.idGender
                LEFT JOIN Title t ON t.idTitle = cp.idTitle
                LEFT JOIN STRING" + idLang + @" s ON g.nameGender=s.stringKey 
        ...
        public DataTable GetIfExistValidatePerson(string initials, string midname, string lastname, DateTime birthdate)
        {
            string query = string.Format(@"  SELECT Count (*) as CountPerson  FROM ContactPerson cp             
              WHERE cp.initialsContPers = '" + initials + "' and cp.midname = '" + midname + "' and cp.lastname = '" + lastname + "' and CAST( cp.birthdate AS date) = '" + birthdate.ToString("MM/dd/yyyy") + "'");


            SqlParameter[] sqlParemeters = new SqlParameter[1];

            sqlParemeters[0] = new SqlParameter("@birthdate", SqlDbType.DateTime);
            sqlParemeters[0].Value = birthdate;
