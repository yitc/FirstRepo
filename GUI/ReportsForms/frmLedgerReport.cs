...
{
    public partial class frmLedgerReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmLedgerReport(DataTable irep, string name, string from, string to)
        {
            this.irep1 = irep;
        ...
        private void frmLedgerReport_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource rdSource = new ReportDataSource("Ledger", (DataTable)dataTableCopy);
