...
namespace GUI
{
    public partial class frmReportBookedPersonOption : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        //Konstruktor za 
        public frmReportBookedPersonOption(DataTable dt11)
        {
        ...
        private void frmReportBookedPersonOption_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ReportDataSource rdSource = new ReportDataSource("BookedPersonOptionDataSet", (DataTable)dataTable);
                ...
                ReportClassBookedPersonOption tr = new ReportClassBookedPersonOption();
                reportName = "Reports//ReportBookedPersonOptionPreview.rdlc";
                ...
                string reportPath = Path.Combine(exeFolder, "Reports//ReportBookedPersonOptionPreview.rdlc");
