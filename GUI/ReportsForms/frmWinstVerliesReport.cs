...
{
    public partial class frmWinstVerliesReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmWinstVerliesReport(DataTable irep, string name)
        {
            this.irep1 = irep;
        ...
        private void frmWinstVerliesReport_Load(object sender, EventArgs e)
        {
