...
namespace GUI
{
    public partial class frmReportPassengerList : Telerik.WinControls.UI.RadForm
    {
         string reportName;
        ...
        //Konstruktor za 
        public frmReportPassengerList(DataTable dt5)
        {
        ...
        private void frmReportPassengerList_Load(object sender, EventArgs e)
        {
            ...
            else
            {
               ...
               // string h = "";
                ...
                ReportDataSource rdSource = new ReportDataSource("PassengerListDataSet", (DataTable)dataTable);
                ...
                ReportClassPassengerList tr = new ReportClassPassengerList();
                reportName = "Reports//ReportPassengerListPreview.rdlc";
                ...
                string reportPath = Path.Combine(exeFolder, "Reports//ReportPassengerListPreview.rdlc");
