...
namespace GUI
{
    public partial class frmReportDevice : Telerik.WinControls.UI.RadForm
    {
       string reportName;
        ...
        //Konstruktor za 
        public frmReportDevice(DataTable dt1)
        {
        ...
        private void frmReportDevice_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ReportDataSource rdSource = new ReportDataSource("DeviceDataSet", (DataTable)dataTable);
                ...
                ReportClassDevice tr = new ReportClassDevice();
                reportName = "Reports//ReportDevicePreview.rdlc";
                ...
                string reportPath = Path.Combine(exeFolder, "Reports//ReportDevicePreview.rdlc");
