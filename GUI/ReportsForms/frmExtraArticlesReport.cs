...
namespace GUI
{
    public partial class frmExtraArticlesReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmExtraArticlesReport(DataTable dt1)
        {
        ...
        private void frmExtraArticlesReport_Load(object sender, EventArgs e)
        {
            ...
            if (dataTable != null) // ako je datatable null
            {
                ...
                else
                {
                    ...
                    ReportDataSource rdSource = new ReportDataSource("ExtraArticleDS", (DataTable)dataTable);
                    ...
                    string reportPath = Path.Combine(exeFolder, "Reports//ExtraArticlesReport.rdlc");
