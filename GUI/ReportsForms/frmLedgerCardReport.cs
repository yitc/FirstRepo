...
namespace GUI
{
    public partial class frmLedgerCardReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmLedgerCardReport(DataTable dt1, string name, string from, string to)
        {
        ...
        private void frmLedgerCardReport_Load(object sender, EventArgs e)
        {
            ...
            if (dataTable != null) // ako je datatable null
            {
                ...
                else
                {
                    ...
                    ReportDataSource rdSource = new ReportDataSource("LedgerCardDS", (DataTable)dataTable);
                    ...
                    string reportPath = Path.Combine(exeFolder, "Reports//LedgerCardReport.rdlc");
