...
namespace GUI
{
    public partial class frmReportNumberBookings : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        public frmReportNumberBookings(DataTable NrBookings)
        {

            dataTable = NrBookings;
            InitializeComponent();

        }

        private void frmReportNumberBookings_Load(object sender, EventArgs e)
        {
            ...
            if (dataTable != null)
            {
                ...
                else
                {
                    ...
                    ReportDataSource rdSource = new ReportDataSource("NumberBookingsDataSet", (DataTable)dataTable);
                    ...
                    ReportClassNumberBookings tr = new ReportClassNumberBookings();
                    reportName = "Reports//ReportNumberBookingsPreview.rdlc";
                    ...
                    string reportPath = Path.Combine(exeFolder, "Reports//ReportNumberBookingsPreview.rdlc");
