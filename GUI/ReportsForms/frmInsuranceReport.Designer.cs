namespace GUI.ReportsForms
{
    partial class frmInsuranceReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource2.Name = "Insurance";
            reportDataSource2.Value = this.InsuranceReportModelBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GUI.Reports.InsuranceReport.rdlc";
            ...
            this.Load += new System.EventHandler(this.frmInsuranceReport_Load);
