...
{
    public partial class frmPeriodSelectionTotalReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmPeriodSelectionTotalReport(DataTable irep, string name)
        {
            this.irep1 = irep;
        ...
        private void frmPeriodSelectionTotalReport_Load(object sender, EventArgs e)
        {
            ...
            ReportDataSource rdSource = new ReportDataSource("Period", (DataTable)dataTableCopy);
