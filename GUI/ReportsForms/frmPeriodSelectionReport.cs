...
{
    public partial class frmPeriodSelectionReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmPeriodSelectionReport(DataTable irep, string name)
        {
            this.irep1 = irep;
        ...
        private void frmPeriodSelectionReport_Load(object sender, EventArgs e)
        {
