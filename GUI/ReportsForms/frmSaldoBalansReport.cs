...
{
    public partial class frmSaldoBalabsReport : Telerik.WinControls.UI.RadForm
    {
        ...
        public frmSaldoBalabsReport(DataTable irep, string name)
        {
            this.irep1 = irep;
        ...
        private void frmSaldoBalabsReport_Load(object sender, EventArgs e)
        {
