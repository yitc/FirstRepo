...
namespace GUI
{
    public partial class frmMMR_Reispapieren_Coordinator_Kleine_Busjes : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmMMR_Reispapieren_Coordinator_Kleine_Busjes(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmMMR_Reispapieren_Coordinator_Kleine_Busjes_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\MMR_Reispapieren_Coordinator_Kleine_Busjes.rdlc");
