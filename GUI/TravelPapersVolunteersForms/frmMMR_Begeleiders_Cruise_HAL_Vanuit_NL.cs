...
namespace GUI
{
    public partial class frmMMR_Begeleiders_Cruise_HAL_Vanuit_NL : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmMMR_Begeleiders_Cruise_HAL_Vanuit_NL(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmMMR_Begeleiders_Cruise_HAL_Vanuit_NL_Load(object sender, EventArgs e)
        {
            if (dataTable != null)
                ...
                else
                {
                    ...
                    string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\MMR_Begeleiders_Cruise_HAL_Vanuit_NL.rdlc");
