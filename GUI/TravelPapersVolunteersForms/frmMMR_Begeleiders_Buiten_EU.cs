...
namespace GUI
{
    public partial class frmMMR_Begeleiders_Buiten_EU : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmMMR_Begeleiders_Buiten_EU(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmMMR_Begeleiders_Buiten_EU_Load(object sender, EventArgs e)
        {
            if (dataTable != null)
                ...
                else
                {
                    ...
                    string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\MMR_Begeleiders_Buiten_EU.rdlc");
