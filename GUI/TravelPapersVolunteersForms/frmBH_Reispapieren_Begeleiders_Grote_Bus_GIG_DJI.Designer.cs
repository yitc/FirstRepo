namespace GUI
{
    partial class frmBH_Reispapieren_Begeleiders_Grote_Bus_GIG_DJI
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource4.Name = "ArrangementRemaining";
            reportDataSource4.Value = this.ArrangementRemainingModelBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource2);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource3);
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource4);
            this.reportViewer1.LocalReport.EnableHyperlinks = true;
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "GUI.TravelPapersVolunteers.SubBH_Reispapieren_Begeleiders_Grote_Bus_GIG_DJI.rdlc";
            this.reportViewer1.Location = new System.Drawing.Point(0, 0);
            this.reportViewer1.Name = "reportViewer1";
            this.reportViewer1.Size = new System.Drawing.Size(996, 516);
            this.reportViewer1.TabIndex = 0;
            // 
            // frmBH_Reispapieren_Begeleiders_Grote_Bus_GIG_DJI
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
            this.ClientSize = new System.Drawing.Size(996, 516);
            this.Controls.Add(this.reportViewer1);
            this.Name = "frmBH_Reispapieren_Begeleiders_Grote_Bus_GIG_DJI";
            // 
            // 
            // 
            this.RootElement.ApplyShapeToControl = true;
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "BH_Reispapieren_Begeleiders_Grote_Bus_GIG_DJI";
            this.ThemeName = "Windows8";
            this.Load += new System.EventHandler(this.frmBH_Reispapieren_Begeleiders_Grote_Bus_GIG_DJI_Load);
