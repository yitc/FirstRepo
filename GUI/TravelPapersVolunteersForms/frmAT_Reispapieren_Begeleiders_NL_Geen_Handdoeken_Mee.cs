...
namespace GUI
{
    public partial class frmAT_Reispapieren_Begeleiders_NL_Geen_Handdoeken_Mee : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmAT_Reispapieren_Begeleiders_NL_Geen_Handdoeken_Mee(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmAT_Reispapieren_Begeleiders_NL_Geen_Handdoeken_Mee_Load(object sender, EventArgs e)
        {
            if (dataTable != null)
                ...
                else
                {
                    ...
                    string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\AT_Reispapieren_Begeleiders_NL_Geen_Handdoeken_Mee.rdlc");
