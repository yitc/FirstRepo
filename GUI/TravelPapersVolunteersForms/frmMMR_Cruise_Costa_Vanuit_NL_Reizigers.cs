...
namespace GUI
{
    public partial class frmMMR_Cruise_Costa_Vanuit_NL_Reizigers : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmMMR_Cruise_Costa_Vanuit_NL_Reizigers(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmMMR_Cruise_Costa_Vanuit_NL_Reizigers_Load(object sender, EventArgs e)
        {
            if (dataTable != null)
                ...
                else
                {
                    ...
                    string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\MMR_Cruise_Costa_Vanuit_NL_Reizigers.rdlc");
