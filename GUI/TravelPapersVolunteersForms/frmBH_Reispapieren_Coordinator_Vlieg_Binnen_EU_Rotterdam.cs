...
namespace GUI
{
    public partial class frmBH_Reispapieren_Coordinator_Vlieg_Binnen_EU_Rotterdam : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmBH_Reispapieren_Coordinator_Vlieg_Binnen_EU_Rotterdam(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmBH_Reispapieren_Coordinator_Vlieg_Binnen_EU_Rotterdam_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\BH_Reispapieren_Coordinator_Vlieg_Binnen_EU_Rotterdam.rdlc");
