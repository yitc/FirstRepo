...
namespace GUI
{
    public partial class frmBH_Reispapieren_Begeleiders_CarCruise : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmBH_Reispapieren_Begeleiders_CarCruise(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmBH_Reispapieren_Begeleiders_CarCruise_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapersVolunteers\\BH_Reispapieren_Begeleiders_CarCruise.rdlc");
