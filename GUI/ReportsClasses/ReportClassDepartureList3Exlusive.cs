...
namespace GUI
{
    ...
    class ReportClassDepartureList3Exclusive : System.Windows.Forms.UserControl
    {
        string xReport;
        DataTable dt;
        FileStream streamingReport;

        public void transl(string reportName, DataTable dtReport, string label, string type)
        {
            ...
            rdlcXML.Save("GUI.ReportDepartureList3ExclusivePreview.rdlc");
        }
        ...
        private void addTable(XmlDocument rdlcXML)
        {
            ...
            //for (int i = 0; i < 2; i++)
            {
                ...
                using (ResXResourceSet resxSet = new ResXResourceSet(Login.resxFile))
                {
                    ...
                    {
                        wColumn = (decimal)(110) * (decimal)0.0138889;
                    }
