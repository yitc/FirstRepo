...
namespace GUI
{
    ...
    class ReportClassListWithExpired : System.Windows.Forms.UserControl
    {
        string xReport;
        DataTable dt;
        ...
        public void transl(string reportName, DataTable dtReport)
        {
            ...
            rdlcXML.Save("GUI.ListWithExpiredPreview.rdlc");
        }
        ...
        private void addTable(XmlDocument rdlcXML)
        {
            ...
            //Za brisanje kolona iz datatable za prikaz reporta bez ID-jeva
