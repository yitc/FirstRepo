...
namespace GUI
{
    ...
    class ReportClassNumberOptions : System.Windows.Forms.UserControl
    {
        string xReport;
        DataTable dt;
        ...
        private void addTable(XmlDocument rdlcXML)
        {
            ...
            //for (int i = 0; i < 2; i++)
            {
                    ...
                    else
                    {
                        if (dt.Columns[i].Caption != null)
                        {
                            ...
                            else if (dt.Columns[i].ColumnName.StartsWith("nameArrType"))
                            {
                                ...
                                {
                                    wColumn = (decimal)(this.CreateGraphics().MeasureString(xValue.InnerXml, this.Font).Width + 95) * (decimal)0.0138889;
                                }
                            }
                ...
                xTextBox3.SetAttribute("Name", "Textbox" + (dt.Columns.Count + i + 3).ToString());
                ...
                else if (dt.Columns[i].ColumnName.StartsWith("Column_") || dt.Columns[i].ColumnName.StartsWith("nrTraveler"))
                {
                ...
                xRD3.InnerXml = "Textbox" + (dt.Columns.Count + i + 3).ToString();
