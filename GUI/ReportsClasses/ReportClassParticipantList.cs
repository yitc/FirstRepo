...
namespace GUI
{
    ...
    class ReportClassParticipantList : System.Windows.Forms.UserControl
    {
        string xReport;
        DataTable dt;
        ...
        public void transl(string reportName, DataTable dtReport)
        {
            ...
            rdlcXML.Save("GUI.ReportParticipantListPreview.rdlc");
        }
        ...
        private void addTable(XmlDocument rdlcXML)
        {
            ...
            //for (int i = 0; i < 2; i++)
            {
                ...
                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(new ParticipantListReportModel());
