...
namespace GUI
{
    ...
    class ReportClassDepartureList2Inclusive : System.Windows.Forms.UserControl
    {
        string xReport;
        DataTable dt;
        ...
        public void transl(string reportName, DataTable dtReport)
        {
            ...
            rdlcXML.Save("GUI.ReportDepartureList2InclusivePreview.rdlc");
        }
        ...
        private void addTable(XmlDocument rdlcXML)
        {
            ...
            //for (int i = 0; i < 2; i++)
            {
                ...
                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(new DepartureList2InclusiveModel());
                ...
                using (ResXResourceSet resxSet = new ResXResourceSet(Login.resxFile))
                {
                    ...
                    if (xValue.InnerXml.Contains(" "))
                    {
                        ...
                        wColumn = (decimal)(this.CreateGraphics().MeasureString(LongestWordInArray, this.Font).Width + 25) * (decimal)0.0138889;
                    }
                    ...
                    {
                        wColumn = (decimal)(50) * (decimal)0.0188889;
                    }
                    ...
                    else if (dt.Columns[i].ColumnName == "nr")
                    {
                        ...
                        wColumn = (decimal)(50) * (decimal)0.0158889;

                    }
                    else if (dt.Columns[i].ColumnName == "nrTraveler")
                    {
                        wColumn = (decimal)(50) * (decimal)0.013000;
                    ...
                    {
                        wColumn = (decimal)(48) * (decimal)0.0138889;
                    }
                    else if (dt.Columns[i].ColumnName == "arrangement")
                    {
                        wColumn = (decimal)(121) * (decimal)0.0199989;
                    }
                ...
                xFontWeightS.InnerXml = "=IIF(Fields!Label.Value =\"" + str + "\" OR Fields!Label.Value =\"" + str1 + "\" ,\"Bold\",\"Default\")"; ;
                ...
                xBackgroundColor2.InnerXml = "=IIF(Fields!Label.Value =\"" + str + "\" OR Fields!Label.Value =\"" + str1 + "\" ,\"LightGrey\",\"Transparent\")"; 
               ...
               //
                ...
                //XmlElement xFontWeightS = rdlcXML.CreateElement("FontWeight", rdlcXML.DocumentElement.NamespaceURI);
                //xFontWeightS.InnerXml = "Bold";
                //xMainStyle2.AppendChild(xFontWeightS);
                ...
                xRow2.AppendChild(xRowCellsHeader2);
                 ...
                 else
                 {
                     ...
                     xValue2.InnerXml = "=Mid(Fields!" + dt.Columns[i].ColumnName + ".Value,Instr(Fields!" + dt.Columns[i].ColumnName + ".Value,\"_\")+1)";
                     //dtF.InnerXml = "=Fields!" + dt.Columns[i].ColumnName + ".Value";
                     //}
                     //xFields.InnerXml = dt.Columns[i].ColumnName;
