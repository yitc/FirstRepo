...
namespace GUI
{
    ...
    class ReportClassDevice : System.Windows.Forms.UserControl
    {
        string xReport;
        DataTable dt;
        ...
        public void transl(string reportName, DataTable dtReport)
        {
            ...
            rdlcXML.Save("GUI.ReportDevicePreview.rdlc");
        }
        ...
        private void addTable(XmlDocument rdlcXML)
        {
            ...
            //dt.Columns.Remove("nameArrangement1");        
            ...
            //for (int i = 0; i < 2; i++)
            {
                ...
                //if (dt.Columns[i].ColumnName == "nameArrangement")
                //{
                //    continue;

                //}
                //if (dt.Columns[i].ColumnName == "dtFromArrangement")
                //{
                //    continue;
                //}
                //if (dt.Columns[i].ColumnName == "dtToArrangement")
                //{
                //    continue;
                //}

                ////// oznaka za polja 1 polja u nazivu
                //if (dt.Columns[i].ColumnName != "nameArrangement1")
                //{
                //    continue;

                //}
                //if (dt.Columns[i].ColumnName != "dtFromArrangement1")
                //{
                //    continue;
                //}
                //if (dt.Columns[i].ColumnName != "dtToArrangement1")
                //{
                //    continue;
                //}
            ...
            //xOver.Add(typeof(DeviceReportModel), "nameArrangement1", attrs);
