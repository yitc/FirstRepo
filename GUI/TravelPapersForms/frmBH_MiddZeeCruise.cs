...
namespace GUI
{
    public partial class frmBH_MiddZeeCruise : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmBH_MiddZeeCruise(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmBH_MiddZeeCruise_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapers//BH_MiddZeeCruise.rdlc");
