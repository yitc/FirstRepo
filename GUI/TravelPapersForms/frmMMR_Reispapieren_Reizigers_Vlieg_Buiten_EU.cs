...
namespace GUI
{
    public partial class frmMMR_Reispapieren_Reizigers_Vlieg_Buiten_EU : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmMMR_Reispapieren_Reizigers_Vlieg_Buiten_EU(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmMMR_Reispapieren_Reizigers_Vlieg_Buiten_EU_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapers\\MMR_Reispapieren_Reizigers_Vlieg_Buiten_EU.rdlc");
