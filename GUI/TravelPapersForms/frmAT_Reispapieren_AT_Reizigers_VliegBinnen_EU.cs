...
namespace GUI
{
    public partial class frmAT_Reispapieren_AT_Reizigers_VliegBinnen_EU : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmAT_Reispapieren_AT_Reizigers_VliegBinnen_EU(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmAT_Reispapieren_AT_Reizigers_VliegBinnen_EU_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapers\\AT_Reispapieren_AT_Reizigers_VliegBinnen_EU.rdlc");
