...
namespace GUI
{
    public partial class frmBH_KleineBusjes : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmBH_KleineBusjes(DataTable dt1, DataTable dt2, DataTable dt3,DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmBH_KleineBusjes_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapers//BH_KleineBusjes.rdlc");
