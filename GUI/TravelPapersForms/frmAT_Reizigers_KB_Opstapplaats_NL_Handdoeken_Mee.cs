...
namespace GUI
{
    public partial class frmAT_Reizigers_KB_Opstapplaats_NL_Handdoeken_Mee : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmAT_Reizigers_KB_Opstapplaats_NL_Handdoeken_Mee(DataTable dt1, DataTable dt2, DataTable dt3,DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmAT_Reizigers_KB_Opstapplaats_NL_Handdoeken_Mee_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string reportPath = Path.Combine(exeFolder, "C:\\TravelPapers\\AT_Reizigers_KB_Opstapplaats_NL_Handdoeken_Mee.rdlc");
