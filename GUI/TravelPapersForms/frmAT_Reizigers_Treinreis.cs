...
namespace GUI
{
    public partial class frmAT_Reizigers_Treinreis : Telerik.WinControls.UI.RadForm
    {
        string reportName;
        ...
        string res = "";
        public frmAT_Reizigers_Treinreis(DataTable dt1, DataTable dt2, DataTable dt3, DataTable dt4)
        {
            dataTable = dt1;
            dataTableNew = dt2;
            dataTableNew2 = dt3;
        ...
        private void frmAT_Reizigers_Treinreis_Load(object sender, EventArgs e)
        {
