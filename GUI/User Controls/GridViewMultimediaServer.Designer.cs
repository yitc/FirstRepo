namespace GUI
{
    partial class GridViewMultimediaServer
    {
        /// <summary> 
       ...
       // private System.ComponentModel.IContainer components = null;
        ...
        //    this.gridArrangement.EnableFastScrolling = true;
        //    this.gridArrangement.EnterKeyMode = Telerik.WinControls.UI.RadGridViewEnterKeyMode.EnterMovesToNextRow;
        ...
        //    this.gridArrangement.MasterTemplate.AutoSizeColumnsMode = Telerik.WinControls.UI.GridViewAutoSizeColumnsMode.Fill;
        ...
        //    this.gridArrangement.Text = "Voluntary Grid Function";
        //    this.gridArrangement.ThemeName = "VisualStudio2012Light";
        //    this.gridArrangement.CurrentRowChanged += new Telerik.WinControls.UI.CurrentRowChangedEventHandler(this.gridVoluntary_CurrentRowChanged);
        //    this.gridArrangement.CellDoubleClick += new Telerik.WinControls.UI.GridViewCellEventHandler(this.gridVoluntary_CellDoubleClick);
        //    this.gridArrangement.GroupSummaryEvaluate += new Telerik.WinControls.UI.GroupSummaryEvaluateEventHandler(this.gridVoluntary_GroupSummaryEvaluate);
        //    this.gridArrangement.DataBindingComplete += new Telerik.WinControls.UI.GridViewBindingCompleteEventHandler(this.gridVoluntary_DataBindingComplete);
        //    // 
        //    // GridViewArrangement
        //    // 
