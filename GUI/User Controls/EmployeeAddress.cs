...
namespace GUI
{
    ...
    public partial class EmployeeAddress : UserControl
    {
        ...
        private void setTranslation()
        {
            ...
            {
                tabAddressContainer.TabPages[0].Text = resxSet.GetString("Address");
                tabAddressContainer.TabPages[1].Text = resxSet.GetString("Billing address");
                tabAddressContainer.TabPages[2].Text = resxSet.GetString("Emergency address");
        ...
        private void EmployeeAddress_Load(object sender, EventArgs e)
        {
        ...
        private void txt_badr_zip_Enter(object sender, EventArgs e)
        {
